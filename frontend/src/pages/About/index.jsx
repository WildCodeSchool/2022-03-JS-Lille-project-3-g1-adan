  ...
  return (
    <SAbout>
      ...
      <p>
        ...
        agent. Il est courant que lors d’une prestation, ces « petits » artistes
        reçoivent en échange de leur services des prestations compensatoires ou
        encore un paiement de la main à la main aléatoire.
      </p>
      ...
      <p>
        ...
        prévu. Ces rémunérations, qui n’en sont pas vraiment, ne permettent pas
        à ces artistes de recevoir un salaire à proprement dit, ni de cotiser
        pour leurs droits sociaux. Il existe des organismes, des associations et
        des aides de l'État pour aider ces artistes, mais encore faut-il les
        connaître et prendre le temps de faire les démarches.{" "}
      </p>
      ...
      <p>
        ...
        proposant une gestion administrative et législative de leurs évènements,
        ainsi qu’un réseau inter artistes, source infinie d’opportunités.
      </p>
    </SAbout>
  );
}
